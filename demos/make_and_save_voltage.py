...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        raise ValueError(
            "Requires 2 inputs specifying save destination for voltage and ground truth spike times."
        )
    ...
    samples_per_second = 120000  # Sampling rate of 120kHz
    amplitude = 1  # Amplitude of 3 standard deviations of noise
    percent_shared_noise = 0.3  # Create shared noise across channels
    correlate1_2 = (
        0.10,
        10,
    )  # Set 15% of neuron 2 spikes to occur within 10 samples of a neuron 1 spike
